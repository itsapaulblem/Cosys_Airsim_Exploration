...
class MultiVehicleTestNode(Node):
    ...
    def test_reset(self):
        ...
        if future.result() and future.result().success:
            self.get_logger().info("PASS Reset test passed")
            return True
        else:
            self.get_logger().error("FAIL Reset test failed")
            return False
    ...
    def test_takeoff(self):
        ...
        if future.result() and future.result().success:
            self.get_logger().info("PASS Takeoff test passed")
            return True
        else:
            self.get_logger().error("FAIL Takeoff test failed")
            return False
    ...
    def test_landing(self):
        ...
        if future.result() and future.result().success:
            self.get_logger().info("PASS Landing test passed")
            return True
        else:
            self.get_logger().error("FAIL Landing test failed")
            return False
    ...
    def test_pause_resume(self):
        ...
        if not (future.result() and future.result().success):
            self.get_logger().error("FAIL Pause test failed")
            return False
        ...
        if future.result() and future.result().success:
            self.get_logger().info("PASS Pause/resume test passed")
            return True
        else:
            self.get_logger().error("FAIL Resume test failed")
            return False
