    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'airsim_interfaces.msg.CarState')
            logger.debug(
...
class CarState(metaclass=Metaclass_CarState):
    ...
    def __init__(self, **kwargs):
        ...
        self.maxrpm = kwargs.get('maxrpm', float())
    ...
    @builtins.property
    def maxrpm(self):
        """Message field 'maxrpm'."""
        return self._maxrpm

    @maxrpm.setter
    def maxrpm(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'maxrpm' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'maxrpm' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._maxrpm = value
