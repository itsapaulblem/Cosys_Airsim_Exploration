...
class Metaclass_Land(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from airsim_interfaces.srv import _land
...
class Land(metaclass=Metaclass_Land):
    from airsim_interfaces.srv._land import Land_Request as Request
    from airsim_interfaces.srv._land import Land_Response as Response
