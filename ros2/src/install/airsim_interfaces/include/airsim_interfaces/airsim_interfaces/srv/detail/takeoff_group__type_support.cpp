...
void fetch_function__TakeoffGroup_Request__vehicle_names(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__TakeoffGroup_Request__vehicle_names(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__TakeoffGroup_Request__vehicle_names(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__TakeoffGroup_Request__vehicle_names(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TakeoffGroup_Request_message_member_array[2] = {
  {
    ...
    fetch_function__TakeoffGroup_Request__vehicle_names,  // fetch(index, &value) function pointer
    assign_function__TakeoffGroup_Request__vehicle_names,  // assign(index, value) function pointer
