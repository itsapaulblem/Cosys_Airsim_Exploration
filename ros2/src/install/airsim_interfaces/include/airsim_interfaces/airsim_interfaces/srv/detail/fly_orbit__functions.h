...
#ifndef AIRSIM_INTERFACES__SRV__DETAIL__FLY_ORBIT__FUNCTIONS_H_
#define AIRSIM_INTERFACES__SRV__DETAIL__FLY_ORBIT__FUNCTIONS_H_
...
/// Initialize srv/FlyOrbit message.
/**
...
/// Create srv/FlyOrbit message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * airsim_interfaces__srv__FlyOrbit_Request__init().
...
/// Destroy srv/FlyOrbit message.
/**
 * It calls
 * airsim_interfaces__srv__FlyOrbit_Request__fini()
...
/// Check for srv/FlyOrbit message equality.
/**
...
/// Initialize array of srv/FlyOrbit messages.
/**
...
/// Finalize array of srv/FlyOrbit messages.
/**
 * It calls
 * airsim_interfaces__srv__FlyOrbit_Request__fini()
...
/// Create array of srv/FlyOrbit messages.
/**
 * It allocates the memory for the array and calls
 * airsim_interfaces__srv__FlyOrbit_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FlyOrbit messages.
/**
 * It calls
 * airsim_interfaces__srv__FlyOrbit_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FlyOrbit message array equality.
/**
...
/// Copy an array of srv/FlyOrbit messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * airsim_interfaces__srv__FlyOrbit_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
...
/**
 * It calls
 * airsim_interfaces__srv__FlyOrbit_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
...
/**
 * It allocates the memory for the array and calls
 * airsim_interfaces__srv__FlyOrbit_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
...
/**
 * It calls
 * airsim_interfaces__srv__FlyOrbit_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AIRSIM_INTERFACES__SRV__DETAIL__FLY_ORBIT__FUNCTIONS_H_
