...
#ifndef AIRSIM_INTERFACES__SRV__DETAIL__LAND__FUNCTIONS_H_
 ...
 * calls
 * airsim_interfaces__srv__Land_Request__init().
...
/**
 * It calls
 * airsim_interfaces__srv__Land_Request__fini()
...
/// Check for srv/Land message equality.
/**
 ...
 * airsim_interfaces__srv__Land_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * airsim_interfaces__srv__Land_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Land message array equality.
/**
...
/// Copy an array of srv/Land messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * airsim_interfaces__srv__Land_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
...
/**
 * It calls
 * airsim_interfaces__srv__Land_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
...
/**
 * It allocates the memory for the array and calls
 * airsim_interfaces__srv__Land_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
...
/**
 * It calls
 * airsim_interfaces__srv__Land_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AIRSIM_INTERFACES__SRV__DETAIL__LAND__FUNCTIONS_H_
