...
/// Check for msg/GimbalAngleEulerCmd message equality.
/**
...
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
bool
airsim_interfaces__msg__GimbalAngleEulerCmd__are_equal(const airsim_interfaces__msg__GimbalAngleEulerCmd * lhs, const airsim_interfaces__msg__GimbalAngleEulerCmd * rhs);

/// Copy a msg/GimbalAngleEulerCmd message.
/**
...
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
bool
airsim_interfaces__msg__GimbalAngleEulerCmd__copy(
  const airsim_interfaces__msg__GimbalAngleEulerCmd * input,
  airsim_interfaces__msg__GimbalAngleEulerCmd * output);
...
/// Check for msg/GimbalAngleEulerCmd message array equality.
/**
...
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
bool
airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence__are_equal(const airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence * lhs, const airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence * rhs);

/// Copy an array of msg/GimbalAngleEulerCmd messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
ROSIDL_GENERATOR_C_PUBLIC_airsim_interfaces
bool
airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence__copy(
  const airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence * input,
  airsim_interfaces__msg__GimbalAngleEulerCmd__Sequence * output);
