...
{
  new (message_memory) airsim_interfaces::msg::Altimeter(_init);
}

void Altimeter_fini_function(void * message_memory)
{
  auto typed_message = static_cast<airsim_interfaces::msg::Altimeter *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Altimeter_message_member_array[4] = {
  {
    ...
    offsetof(airsim_interfaces::msg::Altimeter, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(airsim_interfaces::msg::Altimeter, altitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(airsim_interfaces::msg::Altimeter, pressure),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(airsim_interfaces::msg::Altimeter, qnh),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Altimeter_message_members = {
  ...
  4,  // number of fields
  sizeof(airsim_interfaces::msg::Altimeter),
...
get_message_type_support_handle<airsim_interfaces::msg::Altimeter>()
{
  return &::airsim_interfaces::msg::rosidl_typesupport_introspection_cpp::Altimeter_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, airsim_interfaces, msg, Altimeter)() {
  return &::airsim_interfaces::msg::rosidl_typesupport_introspection_cpp::Altimeter_message_type_support_handle;
}
